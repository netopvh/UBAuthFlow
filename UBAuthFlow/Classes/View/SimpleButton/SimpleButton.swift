...
open class SimpleButton: USETransitionButton {
    ...
    open override func draw(_ rect: CGRect) {
        ...
        DispatchQueue.main.async {
            ...
            self.setCornerRadius(self.bounds.height/2, for: .disabled)
            self.setCornerRadius(self.bounds.height/2, for: .highlighted)
        }
    }
    ...
    public init(settings: ButtonSettings) {
    ...
    open func configureButtonStyles() {
        ...
        setBackgroundColor(self.settings.enabledColor, for: .normal, animated: true, animationDuration: 0.2)
        setBackgroundColor(self.settings.highlightedColor, for: .highlighted, animated: true)
        self.titleLabel?.font = self.settings.font
        // rsetBackgroundColor(.gray, for: .disabled, animated: true)
        self.disabledBackgroundColor = self.settings.disabledColor
        self.setTitleColor(self.settings.textColor, for: .normal)
    }
